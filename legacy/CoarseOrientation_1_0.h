...
// Source file:   /home/nex/PX4-Autopilot/src/drivers/cyphal/legacy_data_types/legacy/CoarseOrientation.1.0.uavcan
// Generated at:  2024-11-12 20:17:27.096255 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/home/nex/PX4-Autopilot/src/drivers/cyphal/legacy_data_types/legacy/CoarseOrientation.1.0.uavcan is trying to use a serialization library that was compiled with "
    ...
    const legacy_CoarseOrientation_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // saturated int5[3] fixed_axis_roll_pitch_yaw
        ...
        {
            int8_t _sat0_ = obj->fixed_axis_roll_pitch_yaw[_index0_];
            if (_sat0_ < -16)
            {
                _sat0_ = -16;
            }
            ...
            const int8_t _err0_ = nunavutSetIxx(&buffer[0], capacity_bytes, offset_bits, _sat0_, 5U);
            if (_err0_ < 0)
            {
                return _err0_;
            }
...
static inline int8_t legacy_CoarseOrientation_1_0_deserialize_(
    legacy_CoarseOrientation_1_0* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    {
        out_obj->fixed_axis_roll_pitch_yaw[_index1_] = nunavutGetI8(&buffer[0], capacity_bytes, offset_bits, 5);
        offset_bits += 5U;
    }
