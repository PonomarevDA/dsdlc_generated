...
// Source file:   /home/nex/PX4-Autopilot/src/drivers/cyphal/legacy_data_types/legacy/protocol/dynamic_node_id/server/AppendEntries.1.0.uavcan
// Generated at:  2024-11-12 20:17:27.254741 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/home/nex/PX4-Autopilot/src/drivers/cyphal/legacy_data_types/legacy/protocol/dynamic_node_id/server/AppendEntries.1.0.uavcan is trying to use a serialization library that was compiled with "
...
static inline int8_t legacy_protocol_dynamic_node_id_server_AppendEntries_Request_1_0_deserialize_(
    legacy_protocol_dynamic_node_id_server_AppendEntries_Request_1_0* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
...
static inline int8_t legacy_protocol_dynamic_node_id_server_AppendEntries_Response_1_0_deserialize_(
    legacy_protocol_dynamic_node_id_server_AppendEntries_Response_1_0* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
    if ((out_obj == NULL) || (inout_buffer_size_bytes == NULL) || ((buffer == NULL) && (0 != *inout_buffer_size_bytes)))
    {
        return -NUNAVUT_ERROR_INVALID_ARGUMENT;
