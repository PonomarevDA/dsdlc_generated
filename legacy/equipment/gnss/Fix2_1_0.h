...
// Source file:   /home/nex/PX4-Autopilot/src/drivers/cyphal/legacy_data_types/legacy/equipment/gnss/Fix2.1.0.uavcan
// Generated at:  2024-11-12 20:12:20.912729 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/home/nex/PX4-Autopilot/src/drivers/cyphal/legacy_data_types/legacy/equipment/gnss/Fix2.1.0.uavcan is trying to use a serialization library that was compiled with "
    ...
    const legacy_equipment_gnss_Fix2_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // saturated float32[3] ned_velocity
        ...
        for (size_t _index0_ = 0U; _index0_ < 3UL; ++_index0_)
        {
            ...
            const int8_t _err8_ = nunavutSetF32(&buffer[0], capacity_bytes, offset_bits, obj->ned_velocity[_index0_]);
            if (_err8_ < 0)
            {
                return _err8_;
            }
    ...
    {   // saturated uint2 status
        ...
        const int8_t _err9_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, _sat6_, 2U);
        if (_err9_ < 0)
        {
            return _err9_;
        }
    ...
    {   // saturated uint6 sub_mode
        ...
        const int8_t _err10_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, _sat8_, 6U);
        if (_err10_ < 0)
        {
            return _err10_;
        }
    ...
    {   // saturated float16[<=36] covariance
        ...
        const int8_t _err11_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, obj->covariance.count, 8U);
        if (_err11_ < 0)
        {
            return _err11_;
        }
        offset_bits += 8U;
        for (size_t _index1_ = 0U; _index1_ < obj->covariance.count; ++_index1_)
        {
            float _sat9_ = obj->covariance.elements[_index1_];
            if (isfinite(_sat9_))
            {
...
static inline int8_t legacy_equipment_gnss_Fix2_1_0_deserialize_(
    legacy_equipment_gnss_Fix2_1_0* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    // uavcan.time.SynchronizedTimestamp.1.0 timestamp
    {
        ...
        const int8_t _err15_ = uavcan_time_SynchronizedTimestamp_1_0_deserialize_(
    ...
    {
        out_obj->ned_velocity[_index2_] = nunavutGetF32(&buffer[0], capacity_bytes, offset_bits);
        offset_bits += 32U;
    }
    ...
    for (size_t _index3_ = 0U; _index3_ < out_obj->covariance.count; ++_index3_)
    {
        out_obj->covariance.elements[_index3_] = nunavutGetF16(&buffer[0], capacity_bytes, offset_bits);
        offset_bits += 16U;
    }
