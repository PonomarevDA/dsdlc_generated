...
// Source file:   /home/nex/PX4-Autopilot/src/drivers/cyphal/legacy_data_types/legacy/equipment/camera_gimbal/Status.1.0.uavcan
// Generated at:  2024-11-12 20:17:27.340717 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/home/nex/PX4-Autopilot/src/drivers/cyphal/legacy_data_types/legacy/equipment/camera_gimbal/Status.1.0.uavcan is trying to use a serialization library that was compiled with "
    ...
    const legacy_equipment_camera_gimbal_Status_1_0* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // saturated float16[4] camera_orientation_in_body_frame_xyzw
        ...
        {
            float _sat0_ = obj->camera_orientation_in_body_frame_xyzw[_index0_];
            if (isfinite(_sat0_))
            {
    ...
    {   // saturated float16[<=9] camera_orientation_in_body_frame_covariance
        ...
        offset_bits += 8U;
        for (size_t _index1_ = 0U; _index1_ < obj->camera_orientation_in_body_frame_covariance.count; ++_index1_)
        {
            float _sat1_ = obj->camera_orientation_in_body_frame_covariance.elements[_index1_];
            if (isfinite(_sat1_))
            {
...
static inline int8_t legacy_equipment_camera_gimbal_Status_1_0_deserialize_(
    legacy_equipment_camera_gimbal_Status_1_0* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    // legacy.equipment.camera_gimbal.Mode.1.0 mode
    {
        ...
        const int8_t _err6_ = legacy_equipment_camera_gimbal_Mode_1_0_deserialize_(
    ...
    {
        out_obj->camera_orientation_in_body_frame_xyzw[_index2_] = nunavutGetF16(&buffer[0], capacity_bytes, offset_bits);
        offset_bits += 16U;
    }
    ...
    for (size_t _index3_ = 0U; _index3_ < out_obj->camera_orientation_in_body_frame_covariance.count; ++_index3_)
    {
        out_obj->camera_orientation_in_body_frame_covariance.elements[_index3_] = nunavutGetF16(&buffer[0], capacity_bytes, offset_bits);
        offset_bits += 16U;
    }
