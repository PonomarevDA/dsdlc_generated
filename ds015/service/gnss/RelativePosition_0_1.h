...
// Source file:   /home/nex/PX4-Autopilot/src/drivers/cyphal/ds015/service/gnss/RelativePosition.0.1.dsdl
// Generated at:  2024-11-12 20:17:26.667421 UTC
// Is deprecated: no
// Fixed port-ID: None
...
static_assert( NUNAVUT_SUPPORT_LANGUAGE_OPTION_TARGET_ENDIANNESS == 1693710260,
              "/home/nex/PX4-Autopilot/src/drivers/cyphal/ds015/service/gnss/RelativePosition.0.1.dsdl is trying to use a serialization library that was compiled with "
    ...
    const ds015_service_gnss_RelativePosition_0_1* const obj, uint8_t* const buffer,  size_t* const inout_buffer_size_bytes)
{
    ...
    {   // saturated uint32 time_week_ms
        ...
        const int8_t _err0_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, obj->time_week_ms, 32U);
        if (_err0_ < 0)
        {
            return _err0_;
        }
    ...
    {   // saturated uint16 time_week
        // Saturation code not emitted -- native representation matches the serialized representation.
        const int8_t _err1_ = nunavutSetUxx(&buffer[0], capacity_bytes, offset_bits, obj->time_week, 16U);
        if (_err1_ < 0)
        {
            return _err1_;
        }
    ...
    {   // uavcan.si.unit.length.Vector3.1.0 relative_position
        ...
        int8_t _err3_ = uavcan_si_unit_length_Vector3_1_0_serialize_(
    ...
    ds015_service_gnss_RelativePosition_0_1* const out_obj, const uint8_t* buffer, size_t* const inout_buffer_size_bytes)
{
    ...
    // uavcan.si.unit.length.Vector3.1.0 relative_position
    {
        ...
        const int8_t _err5_ = uavcan_si_unit_length_Vector3_1_0_deserialize_(
